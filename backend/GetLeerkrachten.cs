...
{
    public static class GetLeerkrachten
    {
        [FunctionName("GetLeerkrachten")]

        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "v1/leerkrachten")] HttpRequest req, ILogger log)
        {
